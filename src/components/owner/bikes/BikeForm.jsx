...
const BikeForm = ({ onSubmit }) => {
  ...
  return (
    <form
      ...
      className="bg-card rounded-2xl shadow-sm p-6 space-y-8"
    >
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <Input
            name="brand"
            placeholder="Brand (e.g. Yamaha, KTM)"
            onChange={handleChange}
          />
          <Input
            name="type"
            placeholder="Bike Type (e.g. Cruiser, Sports, Scooter)"
            onChange={handleChange}
          />
        </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          <Input
            name="engine"
            placeholder="Engine (e.g. 155cc)"
            onChange={handleChange}
          />

          <Input
            name="mileage"
            placeholder="Mileage (e.g. 40 km/l)"
            onChange={handleChange}
          />
          ...
          <Input
            name="seating"
            placeholder="Seating (e.g. 2 Persons)"
            onChange={handleChange}
          />

          <Input
            name="condition"
            placeholder="Condition (Good/Excellent)"
            onChange={handleChange}
          />
        </div>
      </section>
      ...
      <div className="flex justify-end">
        <Button
          type="submit"
          className="bg-brand hover:bg-brandDark text-white px-6"
        >
          Add Bike
        </Button>
      </div>
